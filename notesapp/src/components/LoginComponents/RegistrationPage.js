...
render() {
    ...
    return (
        <LoginPageCont>
            ...
            <LoginForm onSubmit={this.props.registerFunction}>
            <LoginInput 
            ...
            type="password"
            />
            <LoginButton type="submit"><NavButtonText>Register</NavButtonText></LoginButton>
            </LoginForm>
            <p className="regTitle">Already a user? Login Here:</p>
            <button className="regButton" onClick={(ev => {ev.preventDefault(); this.props.history.push('/')})}>Login</button>
        </LoginPageCont>
    )
}
