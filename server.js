...
let notes = [{ title:'This is the title', description: 'This is the description', tags: 'hola, camarada, fordes' } ];
server.get('/notes', (req, res) => {
    setTimeout(function(){ res.json(notes); }, 1000);
});
let noteId = 0;
