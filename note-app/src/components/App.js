...
class App extends Component {
  ...
  componentDidMount() {
    ...
    images.map(
      (image, i) =>
        i === imageLength
          ? (image.className = "carousel-img active-img")
          : (image.className = "carousel-img nonactive-img")
    );
  ...
  imgHover = event => {
    this.state.images.forEach(
      (img, i) =>
        img.src === event.target.src ? console.log(event.target.src, i) : false
    );
  };
  nextClick = () => {
    const images = this.state.images.slice();
          ...
          <div className="heading">
            <div className="scene">
              {this.state.images.map(image => (
                <div key={image.alt} className="carousel-cell">
                  <Link to={`${image.link}`}>
                    <img
            ...
            <div className="btns">
              <button
                ...
                className="btn-side-bar menu-options"
              >
                ...
                >
                  <Switch location={location}>
                    ...
                    <Route
                      path="/search"
                      render={props => (
                        <Search {...props} notes={this.props.notes} />
                      )}
                    />
                    <Route
                      path="/trash"
                    ...
                    <Route
                      path="/:id/edit-note"
                      render={props => (
                        <EditNote {...props} update={this.updateNote} />
                      )}
                    />
                    <Route
                      path="/:id/delete-note"
                    ...
                    <Route
                      path="/:id"
                      render={props => (
                        <FullNote {...props} select={this.state.select} />
                      )}
                    />
