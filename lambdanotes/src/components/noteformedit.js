    ...
    return (  
        <React.Fragment>
            ...
            <FormAttrib onSubmit={props.editHandler}>
                <TitleInput type="text" placeholder="Note Title" onChange={props.handleEditChange} value={props.notes.title} name="title" />
                <NoteInput type="textarea" placeholder="Note Content" onChange={props.handleEditChange} value={props.notes.note} name="note" />
                <FormButtonAttrib>
