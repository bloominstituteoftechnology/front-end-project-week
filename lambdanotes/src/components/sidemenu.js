...
const SideMenu = (props) => {
  ...
  if (props.error) buttonArray.push(<LambdaButton
    key="0"
    text="Reload"
    color="red"
    myFunc={() => props.fetcher("https://killer-notes.herokuapp.com/note/get/all")}
  />);

  //If we aren't in the list view, give the user a way to get there.
  if (props.appState !== "list") buttonArray.push(<LambdaButton
    key="1"
  ...
  if (props.appState !== "create") buttonArray.push(<LambdaButton
    key="2"
