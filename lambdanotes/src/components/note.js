    ...
    return (
      <div className="a-note">
        <div className="a-note-nav">
          <Link
            className="a-note-item"
            to={{
              pathname: `/notes/${this.props.location.state.currentNote.id}/EditNote`,
              state: { default: this.props.location.state.currentNote }
            }}
          >
            edit
          </Link>
          <div className="a-note-item">
            <a className="a-note-item" onClick={this.toggle}>
              delete
            </a>
