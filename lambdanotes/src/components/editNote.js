    ...
    return (
        ...
        <div className="links">
            ...
            <Link to ={`/notes/${note._id}/delete`}>
                ...
                <br/>
                <button className="edit-button" onClick={() => this.handleEdit(this.titleField.current.value, this.textBodyField.current.value, note._id, this.props.history)}><span>Submit</span></button>
            </div>
        </div>
        )
    } 
