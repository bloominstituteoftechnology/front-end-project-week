    ...
    return (
        <div className="Note-container">
            ...
            <div className="Note-content">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris egestas mauris sed nibh
...
odio. Praesent sed mauris porta, volutpat ante hendrerit, ultrices nisl.</p>
            </div>
        </div>
    );
};
