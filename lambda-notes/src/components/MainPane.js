...
const StyledMainPane = styled.main`
  ...
  max-width: ${props => props.theme.dimensions.main.maxWidth};
  width: 100%;
  border-style: solid;
    ...
    return (
      <StyledMainPane>
        <Route
          path="/"
          exact
          render={routeProps => <NoteGrid {...routeProps} notes={notes} />}
        />
        <Route
          path="/add/"
          render={routeProps => <NewNote {...routeProps} />}
        />
        <Route
          path="/view/(delete/)?:id"
          render={routeProps => <ViewNote {...routeProps} />}
        />
        <Route
          path="/view/delete/:id/"
          render={routeProps => (
            <DeleteModal {...routeProps} fetchNotes={fetchNotes} />
          )}
        />
        <Route
          path="/edit/:id"
          render={routeProps => <EditNote {...routeProps} />}
        />
      </StyledMainPane>
    );
  }
