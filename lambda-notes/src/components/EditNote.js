...
// }
  ...
  render() {
    ...
    return  (
        ...
        <form className="editNoteWrapper">
         <row>
            <div className="form-group">
                <h4 className="mt-5 mb-5"><strong>Edit Note:</strong></h4>
            ...
            <div>
                <button type="button" className="ml-0 btn btn-md" /*onClick={this.handleSaveNoteButton}*/>Update</button>
            </div>
         </row>
       </form>
