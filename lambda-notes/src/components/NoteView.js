    ...
    return (
      <React.Fragment>
        <div className="row float-right">
          <div><Link to={`/edit/${selectedNote[0]._id}`} className="links"><u>edit</u> </Link></div>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className} external={externalCloseBtn}>
          ...
          <ModalFooter className="row justify-content-around">
            <Button color="danger" className="col-4" onClick={() => this.sendDelete(selectedNote[0]._id)}>Delete</Button>
