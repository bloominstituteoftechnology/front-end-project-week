      ...
      <Col xs='3' className='NavBar px-0'>
        ...
        <Nav>
          <NavItem className="d-flex justify-content-center">
            <NavLink tag={Link} to='/'><Button className='navButton' block>View Your Notes</Button></NavLink>
          </NavItem>
          <NavItem className="d-flex justify-content-center">
            <NavLink tag={Link} to='/add'><Button className='navButton' block>+ Create New Note</Button></NavLink>
          </NavItem>
        </Nav>
      </Col>
    // </div>
