...
import {ListNotes, NewNote, Details, EditNote, DeleteNote} from './components';
    ...
    return (
        ...
        <div>
          ...
          <div className="left-menu">
            <h1>Lambda Notes</h1>
            <Link className="menu-item" to="/list-notes">View Your Notes</Link>
            <Link className="menu-item" to="/new-note">+ Create New Note</Link>
          </div>

          <div className="right-display">

            <Route exact path="/list-notes/"  render={ () => {
            ...
            <Route path="/list-notes/:noteId" exact={!this.state.deleteEnabled} render={ (note) => {let single = this.getNoteDetails(note.match.params.noteId);
                  return (<Details enableDelete={this.enableDelete}  note={single} />)
                }}></Route>

            <Route exact path="/list-notes/:noteId/edit" render={ (note) => {
          ...
          {(this.state.deleteEnabled) ? (<div className="delete">
            <Route  path="/list-notes/:noteId/delete" render={ (note) => {
                let single = this.getNoteDetails(note.match.params.noteId);
                return (<div>
