...
import { SignIn, ExportNote, DeleteLambdaNote, CreateLambdaNote, EditNote, ListNotes, Note } from './components/index';
    ...
    return (
      <div className="app-container">
        ...
        <div>
          ...
          <Route path="/create" render={(props) => <CreateLambdaNote {...props} notes={this.state.notes} />} />
          <Route path="/note/:id/edit" render={(props) => <EditNote {...props} notes={this.state.notes} />} />
          <Route path="/note/:id/delete" render={(props) => <DeleteLambdaNote {...props} notes={this.state.notes} />} />
          <Route path="/export" render={(props) => <ExportNote {...props} notes={this.state.notes} />} />
