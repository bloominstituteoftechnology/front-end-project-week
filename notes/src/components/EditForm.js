...
const EditForm = props => {
    ...
    return (
        <Container>
            <h2>Edit Note:</h2>
            <form>
                <InputTitle onChange={props.inputHandler} placeholder='Note Title' value={props.updateTitle} name='updateTitle' />
                <InputBody onChange={props.inputHandler} placeholder='Note Content' value={props.updateTextBody} name='updateTextBody' />
