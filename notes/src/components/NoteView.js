...
class NoteView extends Component {
    ...
    handleDelete = () => {
        this.toggleModal();
        this.props.deleteNote(this.props.currentNote.title);
            ...
            <div>
                <Row>
                    <Col className='col-3 ml-auto'>
                        ...
                        this.state.modal ? <Modal isOpen={this.state.modal}></Modal>
                        <ModalBody>Delete this note?</ModalBody>
                ...
                <Row className='mt-4'>
                    <Col>
                        <h3 className='font-weight-bold h3-notename'>{this.props.currentNote.title}</h3><br />
