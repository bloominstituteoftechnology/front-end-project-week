    ...
    render() {
        return (
            <div className="createNote">
                ...
                <form className="createForm" onSubmit={(ev) => {ev.preventDefault(); this.props.submit(this.state.tags, this.state.title, this.state.textBody); this.setState({title: '', textBody: ''})}} >
