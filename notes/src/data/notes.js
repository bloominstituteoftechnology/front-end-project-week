const notes = [
  {
    title: 'Note 1',
    content:
      "They say everything looks better with odd numbers of things. But sometimes I put even numbers—just to upset the critics. If you don't think every day is a good day - try missing a few. You'll see. Only eight colors that you need. That is when you can experience true joy, when you have no fear. Steve wants reflections, so let's give him reflections. Let's make some happy little clouds in our world. Trees grow in all kinds of ways.\n\nThey're not all perfectly straight. Not every limb is perfect. Van Dyke Brown is a very nice brown, it's almost like a chocolate brown. Isn't that fantastic that you can create an almighty tree that fast?\n\nSee there, told you that would be easy. There comes a nice little fluffer. Let your imagination be your guide. You are only limited by your imagination.",
    id: 1,
  },
  {
    title: 'Note 2',
