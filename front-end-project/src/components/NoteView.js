...
class NoteView extends Component {
    ...
    render() {
        return (
            ...
            <div className="noteViewButtons"><NavLink to="/edit"> edit </NavLink>
                    <span onClick={this.toggle}>       delete</span></div>
                    <Modal isOpen={this.state.modal} toggle={this.toggle}>
                        <ModalBody>
                            <p>Are you sure you want to delete this?</p>
                            <Button className="modalbutton" onClick={this.toggle} style={{background: "#D0021B"}}> Delete </Button><Button className="button modalbutton" onClick={this.toggle}> Cancel </Button>
                        </ModalBody>
                    </Modal>
        </div>
        )
