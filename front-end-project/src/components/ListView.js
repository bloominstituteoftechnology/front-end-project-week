                ...
                return (
                  ...
                  >
                    <Card className="mein-card">
                      ...
                      >
                        <CardHeader title={`${note.title}`} style={{textShadow: '2px 2px 4px #000000', color: 'white'}}/>
                        <CardContent>
                          <Typography
                            component="p"
                            style={{ overflow: "hidden", height: "10vh", textShadow: '2px 2px 4px #000000', color: 'white'}}
                          >
                            {note.body}
                          </Typography>
                        </CardContent>
