...
class OneNoteView extends Component {
  state = { show: false };
  ...
  render() {
    ...
    if (note) {
      return <OneNote note={note} deleteNote={this.deleteNote} hideModal={this.hideModal} showModal={this.showModal} show={this.state.show} />
    } else {
...
export default connect(mapStateToProps, { getNotes, deleteNote })(OneNoteView);