...
export const noteFetch = noteID => dispatch => {
    ...
    axios
        ...
        .get(`https://clear-39769.herokuapp.com/notes/${noteID}`)
        .then((response) => {
            dispatch({
...
export const notesFetch = () => dispatch => {
    ...
    axios
        ...
        .get("https://clear-39769.herokuapp.com/notes")
        .then((response) => {
            dispatch({
...
export const notesCreate = note => dispatch => {
    ...
    axios
        ...
        .post("https://clear-39769.herokuapp.com/notes", note)
        .then((response) => {
            dispatch({
...
export const notesEdit = note => dispatch => {
    ...
    axios
        ...
        .put(`https://clear-39769.herokuapp.com/notes/${note.id}`, note)
        .then((response) => {
            dispatch({
...
export const notesRemove = noteID => dispatch => {
    ...
    axios
        ...
        .delete(`https://clear-39769.herokuapp.com/notes/${noteID}`)
        .then((response) => {
            dispatch({
