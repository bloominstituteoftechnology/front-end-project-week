...
class Note extends React.Component {
      ...
      if (localStorage.getItem('checkedlist' + this.props.match.params.id)) {
        this.setState({
          checklist: JSON.parse(
            localStorage.getItem('checkedlist' + this.props.match.params.id)
          ),
        });
      } else {
        localStorage.setItem(
          'checkedlist' + this.props.match.params.id,
  ...
  deleteList = index => {
    ...
    localStorage.removeItem(
      'checked' + checklist[index].id + this.props.match.params.id
    );
        ...
        {this.props.fetching ? (
          ...
          <NotesWrapper>
            ...
            <NoteLinksContainer>
              <NoteEditLink
                to={
                  this.props.note ? `/notes/${this.props.note.id}/edit` : null
                }
              >
                edit
              </NoteEditLink>
              ...
              <HeaderTagsContainer>
                ...
                {this.props.note.tags
                  ? this.props.note.tags.map((tag, index) => (
                      <HeaderTags key={index + Math.random()}>
                        {tag.tag}
                        <i
                          onClick={() => this.deleteTag(index, tag.id)}
...
export default connect(
  mapStateToProps,
  { getNote, getNotes, editNote, deleteNote, setNull }
)(Note);
