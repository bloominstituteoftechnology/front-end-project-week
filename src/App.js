...
class App extends Component {
  ...
  handleLogin = () => {
    ...
    axios.post(`https://arcane-bastion-12409.herokuapp.com/api/login`, {username: this.state.usernameInput, password: this.state.passwordInput})
    .then(response => {
  ...
  logout = () => {
    axios.get('https://arcane-bastion-12409.herokuapp.com/api/logout')
    .then(response => {
  ...
  updateServer = () => {
    ...
    axios.put('https://arcane-bastion-12409.herokuapp.com/api/update', { notes: this.state.notes, username: this.state.username })
    .then(response => {
