import { 
    FETCHING_NOTES, GET_ERROR, FETCHED_NOTES,
    PUTTING_NOTE, PUT_ERROR, PUT_NOTE,
    POSTING_NOTE, POST_ERROR, POSTED_NOTE,
    DELETING_NOTE, DELETE_ERROR, DELETED_NOTE } from '../Actions/index.js';
